...
#include <QKeyEvent>
//externs:
const int Width = 11800 ;
const int Height = 11600 ;
const int resolution = 100;
const size_t matrixSize = (Width/resolution)*(Height/resolution);
Arrow* matrix[Width/resolution * Height/resolution];
...
Game::Game()
{
    ...
    flowField = new FlowField(m_view, this);

    player = new Player(flowField);
//    player->setPos(400, 400); useless here as its past ctor
    player->setZValue(10);
    this->addItem(player);
